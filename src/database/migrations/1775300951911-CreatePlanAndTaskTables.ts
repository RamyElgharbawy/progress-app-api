...
export class CreatePlanAndTaskTables1775300951911 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."tasks_status_enum" AS ENUM('started', 'in-progress', 'completed', 'postponed', 'not-started')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."plans_status_enum" AS ENUM('Active', 'Completed', 'Draft')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."task_dependencies_type_enum" AS ENUM('FS', 'SS', 'FF', 'SF')`);
        ...
        await queryRunner.query(`ALTER TABLE "plans" ADD CONSTRAINT "FK_7c5f6f43e87905766afe5590b56" FOREIGN KEY ("created_by") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
